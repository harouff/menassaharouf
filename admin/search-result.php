...
$ret=mysqli_query($con,"select * from users where (fname like '%$searchkey%' || email like '%$searchkey%' || contactno like '%$searchkey%' || password like '%$searchkey%')");
                              $cnt=1;
                             
                              while($row=mysqli_fetch_array($ret) and  $searchkey!="" )
                              {?>
                              <tr>
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td><?php echo $row['contactno'];?><td><?php echo $row['password'];?></td>  <td><?php echo $row['posting_date'];?></td>
                                  <td>
